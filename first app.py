...
.blur-container {
    ...
    padding: 20px;
    border-radius: 10px;
    box-shadow: 10px 10px 10px rgb(28, 4, 4);
    margin-bottom: 20px;
...
.stTextInput, .stNumberInput, .stSelectbox {
    color: rgb(0, 0, 0);
    background: rgba(7, 41, 121, 0.356); 
    backdrop-filter: blur(10px);
    border-radius: 10px;
    border: 1px solid rgb(1, 1, 11);
    padding: 8px;
    margin: 10px 0;
    width: 100%;
}
...
features = np.array([[average_cost, booking_status, delivery_status, price_range]])
